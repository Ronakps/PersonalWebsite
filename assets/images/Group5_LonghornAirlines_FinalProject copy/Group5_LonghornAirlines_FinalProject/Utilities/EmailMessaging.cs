...
namespace Group5_LonghornAirlines_FinalProject.Utilities
{
    public static class EmailMessaging
    {
        ...
        public static void SendEmail(string emailSubject, string emailBody, string recipient)
        {
            // Create a variable for YOUR TEAM'S Email address
            // This is the address that will be SENDING the emails (the FROM address)
            string strFromEmailAddress = "SP24MIS333KTeam5@gmail.com";
            ...
            string strPassword = "olnx nzum kcsy uvqk";

            // This is the name of the business from which you are sending
            string strCompanyName = "Longhorn Airlines";
            ...
            string finalMessage = emailBody + "\n\nThank you for your reservation!\n\n- Longhorn Airline Academy";

            // Create an email address object for the sender address
            // MailAddress constructor takes 2 parameters: the FROM email, and the Display name for the email
            ...
            mm.To.Add(new MailAddress("SP24MIS333KTeam5@gmail.com"));

            //If we want to CC the recipent as well
