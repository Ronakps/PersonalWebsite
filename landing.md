...
<body>
	...
	<section>
		<a href="generic.html" class="image">
			<img src="CollabProjects/Images/basketball.jpeg" alt="" data-position="25% 25%" />
		</a>
		<div class="content">
			<div class="inner">
				<header class="major">
				...
				<ul class="actions">
					...
					<li><a href="CollabProjects/Projects/NBA Salaries/nba_2022-23_all_stats_with_salary.csv" class="button special icon fa-download" download>NBA csv file</a></li>
                </ul>
			</div>
		</div>
	</section>
